...
- `Kodex/app/view/history/src/mosaicMain/kotlin/io/github/stream29/kodex/cli/history/CleanEventView.kt:943` 同时展示 structured result 和 content；其 text content 分支未应用预览上限。
- `Kodex/app/view/history/src/mosaicMain/kotlin/io/github/stream29/kodex/cli/history/AgentHistoryView.kt:370` 在布局测量期间执行完整换行。
- `Kodex/app/view/components/src/mosaicMain/kotlin/io/github/stream29/kodex/cli/components/TerminalText.kt:14` 对每段剩余文本重新调用字素安全截取；超长单行输入会产生近似二次复杂度和大量临时对象。
