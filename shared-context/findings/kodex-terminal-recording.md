...
- 默认纯文本快照会去掉颜色（[TestMosaic.kt:128](../../Kodex/Mosaic/mosaic-testing/src/commonMain/kotlin/com/jakewharton/mosaic/testing/TestMosaic.kt#L128)），不能直接拿来当彩色录制。**本次只核对这一扩展点，未实现/执行快照转录制。**
